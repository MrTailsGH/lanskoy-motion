...
Замеряется четыре числа на файл:
  ...
  атака    от начала файла до пика; по ней звук сдвигается так, чтобы
           пик пришёлся на событие в кадре, а не начало файла
...
if __name__ == '__main__':
    o = main()
    print(f"\n{'файл':<42}{'длина':>7}{'атака':>7}{'пик':>7}{'тембр':>8}")
    for k in sorted(o):
        m = o[k]
        print(f"{k:<42}{m['len']:>7.2f}{m['attack']:>7.2f}{m['peak']:>7.1f}{m['hz']:>8}")
